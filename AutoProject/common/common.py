...
from AutoProject.serializers import ProjectDynamicDeserializer
...
from AutoInterface.models import AutomationTestResult, AutomationCaseApi, AutomationResponseJson, \
