...
from AutoProject.models import Project, ProjectMember, AutomationReportSendConfig
from AutoProject.serializers import ProjectMemberSerializer, AutomationReportSendConfigSerializer, \
