    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(blank=True, max_length=2000, null=True, verbose_name='结论')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_time', models.CharField(blank=True, max_length=20, null=True, verbose_name='job预测时间')),
                ('job_start', models.CharField(blank=True, max_length=50, null=True, verbose_name='job开始时间')),
                ('job_end', models.CharField(blank=True, max_length=50, null=True, verbose_name='job结束时间')),
                ...
                ('error', models.TextField(blank=True, max_length=2000, null=True, verbose_name='error')),
                ('Host', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='AutoProject.Server', verbose_name='Host')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobavg', models.CharField(blank=True, max_length=10, null=True, verbose_name='平均值')),
                ('jobmedian', models.CharField(blank=True, max_length=10, null=True, verbose_name='中间值')),
                ('jobmin', models.CharField(blank=True, max_length=10, null=True, verbose_name='最小时间')),
                ('jobmax', models.CharField(blank=True, max_length=10, null=True, verbose_name='最大时间')),
