...
from TestPlatform.common.common import check_json, record_results
from TestPlatform.models import GlobalHost, AutomationCaseApi, AutomationParameter, AutomationTestResult, AutomationHead, \
