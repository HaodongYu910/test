...
from TestPlatform.serializers import ProjectDynamicDeserializer
...
from TestPlatform.models import AutomationTestResult, AutomationCaseApi, AutomationResponseJson, \
