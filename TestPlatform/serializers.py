...
class base_data_Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = base_data
        fields = ('id', 'content', 'type','select_type','status','remarks','update_time', 'create_time')
...
class base_data_Deserializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = base_data
        fields = ('content', 'type', 'select_type','status','remarks')
...
class stressrecord_Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = stress_record
        fields = ('id', 'version', 'loadserver', 'testdata', 'loop_time', 'start_date','end_date', 'update_time', 'create_time')
        read_only_fields = ('id',)  # 指定只读的 field
...
class stressrecord_Deserializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = stress_record
        fields = ('version', 'loadserver', 'testdata', 'loop_time','start_date','end_date')
...
class duration_record_Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'diagnosis', 'sendserver', 'duration_id','sendtime', 'update_time', 'create_time')
        read_only_fields = ('id',)  # 指定只读的 field
...
class duration_record_Deserializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','patientid', 'accessionnumber', 'studyinstanceuid','studyolduid',  'imagecount', 'imagecount_server', 'aistatus',
                  'diagnosis', 'sendserver','duration_id','sendtime','create_time')
...
class duration_Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = duration
        fields = (
        'id','server','port','aet', 'keyword', 'dicom', 'end_time','sendstatus', 'status','pid','folder', 'update_time', 'create_time')
        read_only_fields = ('id',)  # 指定只读的 field
...
class duration_Deserializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = duration
        fields = ('server','port','aet', 'keyword', 'dicom', 'end_time', 'sendstatus', 'status')
