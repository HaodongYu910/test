...
from TestPlatform.common.WriteDocx import Write
from TestPlatform.common.api_response import JsonResponse
from TestPlatform.common.common import record_dynamic, check_json
from TestPlatform.common.loadSwaggerApi import swagger_api
from TestPlatform.models import Project, ApiGroupLevelFirst, ApiInfo, \
    ApiOperationHistory, APIRequestHistory, ApiHead, ApiParameter, ApiResponse, ApiParameterRaw
from TestPlatform.serializers import ApiGroupLevelFirstSerializer, ApiInfoSerializer, APIRequestHistorySerializer, \
...
class DownLoad(APIView):
    ...
    def get(self, request):
        ...
        return JsonResponse(code="0", msg="成功!", data=url)
