...
from TestPlatform.common.WriteExcel import Write
from TestPlatform.common.addTask import add
from TestPlatform.common.api_response import JsonResponse
from TestPlatform.common.common import record_dynamic, create_json, del_task_crontab
from TestPlatform.common.confighttp import test_api
from TestPlatform.models import Project, AutomationGroupLevelFirst, \
...
from TestPlatform.serializers import AutomationGroupLevelFirstSerializer, AutomationTestCaseSerializer, \
                ...
                if data.get("examineType") == "json":
                    ...
                    if data.get("RegularParam"):
                        AutomationResponseJson(automationCaseApi=api_ids,
                                               ...
                                               type='Regular').save()
                return JsonResponse(data={"api_id": api_id}, code="0", msg="成功！")
            return JsonResponse(code="999998", msg="失败！")
...
class AddTimeTask(APIView):
    ...
    def post(self, request):
        ...
        return JsonResponse(data={"task_id": task_id}, code="0", msg="成功！")
...
class GetTask(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            return JsonResponse(code="0", msg="成功！", data=obj)
        except ObjectDoesNotExist:
            return JsonResponse(code="0", msg="成功！")
        ...
        if obj:
            ...
            for i in data:
                if i["result"] == "PASS":
                    ...
                    not_run = not_run + 1
            return JsonResponse(code="0", msg="成功！", data={"data": data,
                                                                "total": len(data),
                                                                "pass": success,
                                                                "fail": fail,
                                                                "error": error,
...
class DownLoadCase(APIView):
    ...
    def get(self, request):
        ...
        path = "./TestPlatform/ApiDoc/%s.xlsx" % str(obj.name)
