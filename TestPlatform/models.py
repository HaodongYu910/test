...
class stress_data(models.Model):
    ...
    automatic = models.CharField(max_length=5, blank=True, null=True, verbose_name="自动或手动预测")
...
class duration_record(models.Model):
    ...
    sendtime = models.DateTimeField(max_length=20, blank=True, null=True, verbose_name="发送时间")
