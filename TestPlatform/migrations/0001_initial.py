# Generated by Django 2.1.7 on 2020-12-03 16:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('stressid', models.CharField(blank=True, max_length=5, null=True, verbose_name='stress表ID')),
                ('studyuid', models.CharField(blank=True, max_length=200, null=True, verbose_name='测试环境')),
                ('imagecount', models.CharField(blank=True, max_length=400, null=True, verbose_name='测试数据')),
                ('slicenumber', models.CharField(blank=True, max_length=4, null=True, verbose_name='线程数')),
                ('diseases', models.CharField(blank=True, max_length=4, null=True, verbose_name='并发vu')),
                ('start_delay', models.CharField(blank=True, max_length=4, null=True, verbose_name='启动延时 秒')),
            ],
            options={
