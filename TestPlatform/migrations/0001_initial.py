    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagecount', models.CharField(blank=True, max_length=10, null=True, verbose_name='imagecount')),
            ],
            options={
                'verbose_name': 'image',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.TextField(blank=True, max_length=3000, null=True, verbose_name='诊断报告')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
            ],
            options={
