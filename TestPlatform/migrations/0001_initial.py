# Generated by Django 2.1.7 on 2020-07-15 16:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, max_length=1, null=True, verbose_name='类型')),
                ('select_type', models.CharField(blank=True, max_length=100, null=True, verbose_name='查询类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, default='True', max_length=20, null=True, verbose_name='状态')),
        ...
        migrations.CreateModel(
            name='stress_detail_record',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('version', models.CharField(blank=True, max_length=10, null=True, verbose_name='版本')),
                ('testid', models.CharField(blank=True, max_length=100, null=True, verbose_name='testid')),
                ...
                ('seriesinstanceuid', models.CharField(blank=True, max_length=100, null=True, verbose_name='挂载uid')),
                ('diseases', models.CharField(blank=True, max_length=20, null=True, verbose_name='病种')),
                ('duration', models.CharField(blank=True, max_length=20, null=True, verbose_name='预测时间')),
                ...
                ('stability', models.CharField(blank=True, max_length=20, null=True, verbose_name='')),
                ('report', models.CharField(blank=True, max_length=3000, null=True, verbose_name='诊断报告')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
            ],
            options={
