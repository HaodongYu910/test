# Generated by Django 2.1.7 on 2020-12-03 16:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagecount', models.CharField(blank=True, max_length=5, null=True, verbose_name='张数')),
                ('slicenumber', models.CharField(blank=True, max_length=5, null=True, verbose_name='层厚')),
                ('diseases', models.CharField(blank=True, max_length=10, null=True, verbose_name='病种')),
                ('graphql', models.CharField(blank=True, max_length=500, null=True, verbose_name='手动预测json')),
            ],
            options={
