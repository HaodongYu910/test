    ...
    <div style="margin:35px">
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters" @submit.native.prevent>
                <el-form-item>
                    <el-input v-model.trim="filters.name" placeholder="key" @keyup.enter.native="getDictionarylist"></el-input>
                </el-form-item>
        ...
        <el-table :data="project" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="id" label="ID" min-width="8%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="key" label="key" min-width="15%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="value" label="value" min-width="15%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="remarks" label="描述" min-width="20%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="type" label="类型" min-width="15%" sortable show-overflow-tooltip>
            </el-table-column>
...
<script>
    ...
    import { getDictionary, DelDictionary, DisableDictionary, EnableDictionary,
    ...
    export default {
        ...
        methods: {
            ...
            getDictionarylist() {
                ...
                getDictionary(headers, params).then(_data => {
