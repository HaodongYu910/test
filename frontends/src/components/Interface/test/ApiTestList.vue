...
<script>
  ...
  export default {
    ...
    methods: {
      create() {
        this.$router.push('/Interface/test/create');
      },
      select(selection) {
      ...
      handleEdit(test) {
        this.$router.push({
          path: '/Interface/test/edit?id=' + test.id,
        })
      },
      handleView(test) {
        this.$router.push({
          path: '/Interface/test/view?id=' + test.id,
        })
      },
      handleDelete(test) {
        this.$alert(this.$t('load_test.delete_confirm') + test.name + "？", '', {
          ...
          callback: (action) => {
            if (action === 'confirm') {
              this.result = this.$post("/Interface/delete", {id: test.id}, () => {
