...
<script>
import {Scenario, TCPConfig, TCPRequest} from "@/business/components/Interface/test/model/ScenarioModel";
import MsApiAssertions from "@/business/components/Interface/test/components/assertion/ApiAssertions";
import MsApiExtract from "@/business/components/Interface/test/components/extract/ApiExtract";
import MsJsr233Processor from "@/business/components/Interface/test/components/processor/Jsr233Processor";
