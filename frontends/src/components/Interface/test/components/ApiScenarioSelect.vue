...
import MsApiScenarioSelectSubTable from "@/business/components/Interface/test/components/ApiScenarioSelectSubTable";
import {Scenario} from "@/business/components/Interface/test/model/ScenarioModel";
...
export default {
  ...
  methods: {
    search() {
      ...
      let url = "/Interface/list/" + this.currentPage + "/" + this.pageSize;
