...
import MsDubboRegistryCenter from "@/business/components/Interface/test/components/request/dubbo/RegistryCenter";
import MsDubboConfigCenter from "@/business/components/Interface/test/components/request/dubbo/ConfigCenter";
import MsDubboConsumerService from "@/business/components/Interface/test/components/request/dubbo/ConsumerAndService";
import MsDatabaseConfig from "./request/database/DatabaseConfig";
import {parseEnvironment} from "../model/EnvironmentModel";
import MsTcpConfig from "@/business/components/Interface/test/components/request/tcp/TcpConfig";
...
export default {
  ...
  methods: {
    getEnvironments() {
      if (this.projectId) {
        this.result = this.$get('/Interface/environment/list/' + this.projectId, response => {
