    ...
    <section>
        ...
        <el-form :model="form" ref="form" :rules="FormRules">
            <div style="border: 1px solid #e6e6e6;margin-bottom: 10px;padding:15px">
                <el-form-item label="接口分组:" label-width="83px" prop="ApiGroup_id">
                    <el-select v-model="form.ApiGroup_id" placeholder="请选择分组">
        ...
        data() {
            return {
                ...
                FormRules: {
                    ...
                    ApiGroup_id : [{ type: 'number', required: true, message: '请选择分组', trigger: 'blur'}],
                },
                editForm: {
                    name: "",
                    value: "",
        ...
        methods: {
                    ...
                    if (valid) {
                        ...
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            let params = {
                                ...
                                ApiGroup_id: Number(self.form.ApiGroup_id),
                                name: self.form.name,
                                        ...
                                        if (code === '0') {
                                            self.$router.push({name: '分组接口列表',
                                                params: {
                                                    ...
                                                    firstGroup: self.form.ApiGroup_id
                                                }
                                            });
                                            self.$message({
                                                message: '保存成功',
            ...
            getApiGroup() {
                ...
                getApiGroupList(headers, params).then(_data => {
                    ...
                    if (code === '0') {
                        self.group = data;
                        self.form.ApiGroup_id = self.group[0].id
                    }
                    else {
                        self.$message.error({
                            message: msg,
