    ...
    export default {
        ...
        methods: {
            ...
            getCaseApiList() {
                ...
                $.ajax({
                    type: "get",
                    url: test+"/Interface/automation/api_list",
                    async: true,
            ...
            Test(index, row) {
                if (this.url) {
                    ...
                    $.ajax({
                        type: "post",
                        url: test+"/Interface/automation/start_test",
                        async: true,
                        data: JSON.stringify({
            ...
            handleDel(index, row){
                this.$confirm('确认删除该记录吗?', '提示', {
                    ...
                    $.ajax({
                        type: "post",
                        url: test+"/Interface/automation/del_api",
                        async: true,
                        data: JSON.stringify({
                            project_id: Number(this.$route.params.project_id),
                            case_id: Number(this.$route.params.case_id),
            ...
            getApiGroup() {
                ...
                $.ajax({
                    type: "get",
                    url: test+"/Interface/Interface/group",
                    async: true,
                    data: { project_id: this.$route.params.project_id},
                    headers: {
                        Authorization: 'Token '+JSON.parse(sessionStorage.getItem('token'))
            ...
            getApiList(_list) {
                ...
                if (_list) {
                    param['ApiGroup_id'] = Number(_list);
                }
                $.ajax({
                    type: "get",
                    url: test+"/Interface/Interface/api_list",
                    async: true,
                    data: param,
                    headers: {
                        Authorization: 'Token '+JSON.parse(sessionStorage.getItem('token'))
            ...
            getResult(_id){
                ...
                $.ajax({
                    type: "get",
                    url: test+"/Interface/automation/look_result",
                    async: true,
                    data: {
            ...
            addOldApiSubmit() {
                ...
                this.$confirm('确认添加选中记录吗？', '提示', {
                    ...
                    $.ajax({
                        type: "post",
                        url: test+"/Interface/automation/add_old_api",
                        async: true,
                        data:param,
                        headers: {
                            Authorization: 'Token '+JSON.parse(sessionStorage.getItem('token'))
