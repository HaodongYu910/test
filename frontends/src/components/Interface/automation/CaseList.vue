    ...
    <section>
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false" style="width: 65%; left: 17.5%">
            <el-form :model="editForm"  :rules="editFormRules" ref="editForm" label-width="80px">
                ...
                <el-form-item label="接口分组:" label-width="83px" prop="AutomationGroup">
                    <el-select v-model="editForm.AutomationGroup" placeholder="分组">
    ...
    export default {
        ...
        methods: {
            ...
            DownloadApi() {
                $.ajax({
                    type: "get",
                    url: test+"/Interface/automation/DownloadCase",
                    async: true,
            ...
            getHost() {
                ...
                $.ajax({
                    type: "get",
                    url: test+"/Interface/global/host_total",
                    async: true,
            ...
            getTask(){
                ...
                $.ajax({
                    type: "get",
                    url: test+"/Interface/automation/get_time_task",
                    async: true,
                    data: {
            ...
            addTask(){
                ...
                this.$refs.form.validate((valid) => {if (valid) {
                    this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            $.ajax({
                                type: "post",
                                url: test+"/Interface/automation/add_time_task",
                                async: true,
            ...
            delTask(){
                ...
                $.ajax({
                    type: "post",
                    url: test+"/Interface/automation/del_task",
                    async: true,
                    data: JSON.stringify({
                        project_id: Number(self.$route.params.project_id),
                    }),
            ...
            getCaseList() {
                ...
                $.ajax({
                    type: "get",
                    url: test+"/Interface/automation/case_list",
                    async: true,
                    data: param,
                    headers: {
                        Authorization: 'Token '+JSON.parse(sessionStorage.getItem('token'))
            ...
            updateGroupSubmit() {
                ...
                this.$confirm('确认修改所属分组吗？', '提示', {
                    ...
                    let params = JSON.stringify({
                        ...
                        AutomationGroup_id: self.updateGroupForm.firstGroup,
                        ids:ids
                    });
                    $.ajax({
                        type: "post",
                        url: test+"/Interface/automation/update_case_group",
                        async: true,
                        data: params,
                        headers: {
                            "Content-Type": "application/json",
            ...
            getCaseGroup() {
                ...
                $.ajax({
                    type: "get",
                    url: test+"/Interface/automation/group",
                    async: true,
                    data: { project_id: this.$route.params.project_id},
                    headers: {
                        Authorization: 'Token '+JSON.parse(sessionStorage.getItem('token'))
            ...
            handleDel: function (index, row) {
                this.$confirm('确认删除该记录吗?', '提示', {
                    ...
                    $.ajax({
                        type: "post",
                        url: test+"/Interface/automation/del_case",
                        async: true,
                        data: JSON.stringify({
                                project_id: Number(this.$route.params.project_id),
                                ids: [row.id] }),
                    ...
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            let param = JSON.stringify({
                                ...
                                AutomationGroup_id: Number(this.editForm.AutomationGroup),
                                description: self.editForm.description });
                            $.ajax({
                                type: "post",
                                url: test+"/Interface/automation/update_case",
                                async: true,
                                data: param,
                                headers: {
                                    Authorization: 'Token '+JSON.parse(sessionStorage.getItem('token'))
                ...
                this.$refs.addForm.validate((valid) => {
                    if (valid) {
                        ...
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            let param = JSON.stringify({
                                project_id: Number(this.$route.params.project_id),
                                AutomationGroup_id: this.addForm.firstGroup,
                                caseName: self.addForm.caseName,
                                description: self.addForm.description });
                            $.ajax({
                                type: "post",
                                url: test+"/Interface/automation/add_case",
                                async: true,
                                data: param,
                                headers: {
                                    Authorization: 'Token '+JSON.parse(sessionStorage.getItem('token'))
