    ...
    <div class="table">
        ...
        <div class="container">
               ...
               <!--  <el-button type="primary" icon="delete" class="handle-del mr10" @click="delAll">批量删除</el-button> -->
                ...
                <div class="search" style="float:left">
                    ...
                    <el-select v-model="searchform.select_app" clearable  placeholder="筛选" prop="select_app" class="handle-select mr10">
                        <el-option key="每日报告" label="每日报告" value="1"></el-option>
                        <el-option key="测试报告" label="测试报告" value="2"></el-option>
                        <el-option key="质量报告" label="质量报告" value="3"></el-option>
                    </el-select>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                <el-table-column  label="邮件主题" min-width="15%">
                    <template slot-scope="scope">
                        <router-link v-if="scope.row.title" :to="{ name: '邮件详情', params: {report_id: scope.row.report_id}}"
                                 style='text-decoration: none;color: #000000;'>
                        {{ scope.row.title }}
                    </router-link>
                    </template>
                </el-table-column>
                <el-table-column  label="Boimind版本" min-width="10%">
                    <template slot-scope="scope">
                        <span style="margin-left: 10px">{{ scope.row.test_version }}</span>
                    </template>
                </el-table-column>
                <el-table-column  label="CoinNess版本" min-width="10%">
                    <template slot-scope="scope">
                        <span style="margin-left: 10px">{{ scope.row.cns_version}}</span>
                    </template>
                </el-table-column>
                <el-table-column  label="邮件类型" min-width="5%">
                    <template slot-scope="scope">
                ...
                <el-table-column  label="收件人员" min-width="15%">
                    <template slot-scope="scope">
                        <span style="margin-left: 10px">{{ scope.row.receiver }}</span>
                    </template>
                </el-table-column>
                <el-table-column  label="抄送人员" min-width="15%" :formatter="dateFormatter">
                    <template slot-scope="scope">
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="editform" :model="editform" label-width="100px">
                   <el-form-item  label="ID">
                         <el-input :disabled="true" v-model="editform.report_id" width="5%"></el-input>
                    </el-form-item>
                ...
                <el-form-item label="邮件类型">
                   <el-select v-model="editform.type" placeholder="请选择">
                        <el-option key="1" label="每日报告" value="1"></el-option>
                        <el-option key="2" label="测试报告" value="2"></el-option>
                        <el-option key="3" label="质量报告" value="3"></el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="收件人员">
                        <el-select v-model="editform.receiver" placeholder="请选择">
                            ...
                            <el-option key="0" label="当前用户" value="0"></el-option>
                        </el-select>
                </el-form-item>
        ...
        <!-- 添加弹出框 -->
        <el-dialog title="添加" :rules="rules" :visible.sync="dialogFormVisible" width="40%">
            <el-form :model="addForm" :rules="rules" ref="addForm" label-width="120px">
                     <el-form-item  label="邮件主题" prop='title'>
                         <el-input  v-model="addForm.title"></el-input>
                     </el-form-item>
                     <el-form-item  label="Boimind版本" prop='title'>
                         <el-input  v-model="addForm.test_version"></el-input>
                     </el-form-item>
                     <el-form-item  label="CoinNess版本" prop='title'>
                         <el-input  v-model="addForm.cns_version"></el-input>
                     </el-form-item>
                     <el-form-item label="邮件类型">
                ...
                <el-form-item label="收件人员" prop="app">
                    <el-select v-model="addForm.receiver" placeholder="请选择">
                        <el-option key="test" label="测试" value="test"></el-option>
                ...
                <el-form-item label="抄送人员">
                       <el-input  v-model="addForm.email_cc"></el-input>
                </el-form-item>

            </el-form>
            <span slot="footer" class="dialog-footer">
                <el-button @click="dialogFormVisible  = false">取 消</el-button>
                <el-button type="primary" @click="addconfig('addForm')">添加</el-button>
            </span>
        </el-dialog>
...
<script>
    import {loadreport,addreport,updatereport,delreport,Send} from "../../router/api";
    export default {
        name: 'basetable',
        data() {
            return {
                rules:{
                    ...
                    receiver: [
                    {  required: true, message: '输入收件人员', trigger: 'change' },
                    ],
                    type: [
                    {  required: true, message: '输入邮件类型', trigger: 'change' }
                    ],
                    email_cc: [
                    {  required: true, message: '输入抄送人员', trigger: 'change' }
                    ],
                },
                tableData:[],
                cur_page: 1,
        ...
        methods: {
            ...
            addconfig(form){
                ...
                this.$refs[form].validate((valid) => {
                    if (valid) {
                       ...
                       addreport(headers,params).then(_data=>{
            ...
            handleDelete(index, row) {
                ...
                delreport(headers,params).then(_data=>{
                    let{msg,code,data}=_data;
                    if(code!='0'){
                        this.$message.error(msg);
                        return;
