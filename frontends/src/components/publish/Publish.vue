  ...
  <div class="publish">
      ...
      <div class="top-left">
        <div class="top-item">
          ...
          <el-select v-model="unitType" placeholder="请选择">
            <el-option v-for="item in unitList" :key="item" :value="item">
            </el-option>
          </el-select>
        </div>
        <div class="top-item">
          <span class="left">环境：</span>
          <el-select v-model="modeType" placeholder="请选择">
            <el-option v-for="item in modeList" :key="item" :value="item">
            </el-option>
          </el-select>
        </div>
      </div>
    ...
    >
      <div class="dialog-item">
        <span class="left">服务单元：</span>
        <el-select v-model="createUnitType" placeholder="请选择服务单元">
          <el-option v-for="item in unitList" :key="item" :value="item">
          </el-option>
        </el-select>
      </div>
      <div class="dialog-item">
        <span class="left">环境：</span>
        <el-select v-model="createModeType" placeholder="请选择环境">
          <el-option v-for="item in modeList" :key="item" :value="item">
          </el-option>
        </el-select>
      </div>
      ...
      <div class="dialog-item">
        <span>代码分支：</span>
        <el-input placeholder="请输入git代码分支" v-model="branchName">
        </el-input>
      </div>
      <div class="dialog-item">
        <span>部署服务器：</span>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" class="btn" @click="submitAddTask"
          >新 建</el-button
        >
      </div>
    </el-dialog>
