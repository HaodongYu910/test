        ...
        },
        {
            ...
            children:[
                ...
                //項目詳情頁面
                {
                    ...
                    hidden: true,
                    children: [
                        {   path: '/ProjectTitle/project=:project_id', component: ProjectTitle,meta: { title: '项目概况' }, name: '项目概况', leaf: true},
                        {   path: '/GlobalHost/project=:project_id', component: globalHost,meta: { title: 'Host配置' }, name: 'Host配置', leaf: true},
                        {   path: '/api/project=:project_id',
                            ...
                            child: true,
                            children: [
                                {   path: '/apiList/project=:project_id', component: ApiList,meta: { title: '接口列表' }, name: '接口列表'},
                                {   path: '/apiList/project=:project_id/first=:firstGroup',meta: { title: '分组接口列表' }, component: ApiListGroup, name: '分组接口列表'},
                                {   path: '/fastTest/project=:project_id', component: FestTest,meta: { title: '快速测试' }, name: '快速测试'},
                                {   path: '/addApi/project=:project_id', component: addApi,meta: { title: '新增接口' }, name: '新增接口'},
                                {   path: '/detail/project=:project_id/api=:api_id',
                                    component: detail,
                                    name: '接口',
                                    children: [
                                        { path: '/apiInfo/project=:project_id/api=:api_id', component: ApiInfo,meta: { title: '基础信息' }, name: '基础信息'},
                                        { path: '/testApi/project=:project_id/api=:api_id', component: testApi,meta: { title: '测试' }, name: '测试'},
                                        { path: '/apiDynamic/project=:project_id/api=:api_id', component: ApiDynamic,meta: { title: '历史' }, name: '历史'},
                                    ]
                                },
                        ...
                        {   path: '/automationTest/project=:project_id',
                            ...
                            child: true,
                            children: [
                                {   path: '/caseList/project=:project_id', component: CaseList,meta: { title: '用例列表' }, name: '用例列表'},
                                {   path: '/caseList/project=:project_id/first=:firstGroup', component: CaseListGroup,meta: { title: '分组用例列表' }, name: '分组用例列表'},
                                {   path: '/caseApiList/project=:project_id/case=:case_id', component: CaseApiList,meta: { title: '用例接口列表' }, name: '用例接口列表'},
                                {   path: '/addCaseApi/project=:project_id/case=:case_id', component: AddCaseApi,meta: { title: '添加新接口' }, name: '添加新接口'},
                        ...
                        {   path: '/projectMember/project=:project_id', component: ProjectMember,meta: { title: '成员管理' }, name: '成员管理', leaf: true},
                        {   path: '/projectDynamic/project=:project_id', component: ProjectDynamic,meta: { title: '项目动态' }, name: '项目动态', leaf: true},
                        {   path: '/projectReport/project=:project_id', component: ProjectReport,meta: { title: '自动化测试报告' }, name: '自动化测试报告', leaf: true},
                    ]
                }
            ]
        },
