<template>
  <section>
    <el-button class="return-list" @click="back"><i class="el-icon-d-arrow-left" style="margin-right: 5px" />用例列表</el-button>
    ...
    <div>
      <el-table v-loading="listLoading" :data="tableData" :row-style="tableRowStyle" @expand-change="showJson">
          ...
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="返回结果： ">
                <span>
                  <pre v-highlightA style="word-break: break-all;overflow:auto;overflow-x:hidden"><code>{{ props.row.responseData }}</code></pre>
                </span>
              </el-form-item>
            </el-form>
          </template>
