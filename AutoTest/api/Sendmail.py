...
from AutoTest.common.jenkins_api import get_job_details
from AutoTest.common.download_mail import download
from AutoTest.common.sendmail import send_mail
from AutoTest.models import test_report
    ...
    def post(self, request):
        ...
        try:
            if int(data["type"])==0:
                ...
                if re.receiver == 'QualityControl':   # 测试邮件
