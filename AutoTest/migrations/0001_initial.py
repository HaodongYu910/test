    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apiGroupLevelFirst', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='First', to='AutoTest.ApiGroupLevelFirst', verbose_name='所属一级分组')),
            ],
            options={
                'verbose_name': '接口',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AutoTest.ApiInfo', verbose_name='接口')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requestParameter', to='AutoTest.ApiInfo', verbose_name='所属接口')),
            ],
            options={
                'verbose_name': '请求参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='requestParameterRaw', to='AutoTest.ApiInfo', verbose_name='所属接口')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response', to='AutoTest.ApiInfo', verbose_name='所属接口')),
            ],
            options={
                'verbose_name': '返回参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auto_result', to='AutoTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '自动测试结果',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='header', to='AutoTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '请求头',
                'verbose_name_plural': '请求头管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(blank=True, max_length=1024, null=True, verbose_name='内容')),
                ('interrelate', models.BooleanField(default=False, verbose_name='是否关联')),
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parameterList', to='AutoTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '接口参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='parameterRaw', to='AutoTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '源数据参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response', to='AutoTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationGroupLevelFirst', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='automationGroup', to='AutoTest.AutomationGroupLevelFirst', verbose_name='所属用例一级分组')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='test_result', to='AutoTest.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '手动测试结果',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crontab', models.CharField(blank=True, max_length=30, null=True, verbose_name='类型')),
                ('status', models.BooleanField(default=False, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('interfacename', models.CharField(blank=True, max_length=50, null=True, verbose_name='接口名')),
                ('json', models.CharField(blank=True, max_length=2500, null=True, verbose_name='json')),
                ('type', models.CharField(blank=True, max_length=10, null=True, verbose_name='类型')),
                ('status', models.BooleanField(default=False, verbose_name='状态')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dynamic_project', to='AutoTest.Project', verbose_name='所属项目')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='member_project', to='AutoTest.Project', verbose_name='所属项目')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocol', models.CharField(blank=True, max_length=10, null=True, verbose_name='协议')),
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('status', models.BooleanField(default=True, verbose_name='状态')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AutoTest.Project', verbose_name='项目')),
            ],
            options={
                'verbose_name': 'Server',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=False, verbose_name='状态')),
                ('Host', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='AutoTest.Server', verbose_name='Host_id')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='install',
            name='Host',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='AutoTest.Server', verbose_name='Host'),
        ),
        migrations.AddField(
            model_name='custommethod',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AutoTest.Project', verbose_name='项目'),
        ),
        migrations.AddField(
            model_name='automationtesttask',
            name='Host',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AutoTest.Server', verbose_name='HOST'),
        ),
        migrations.AddField(
            model_name='automationtesttask',
            name='project',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='AutoTest.Project', verbose_name='项目'),
        ),
        migrations.AddField(
            model_name='automationtestcase',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AutoTest.Project', verbose_name='所属项目'),
        ),
        migrations.AddField(
            model_name='automationtestcase',
            name='user',
        ...
        migrations.AddField(
            ...
            name='automationTestCase',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='api', to='AutoTest.AutomationTestCase', verbose_name='用例'),
        ),
        migrations.AddField(
            model_name='apiinfo',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='api_project', to='AutoTest.Project', verbose_name='所属项目'),
        ),
        migrations.AddField(
            model_name='apiinfo',
            name='userUpdate',
        ...
        migrations.AddField(
            model_name='apihead',
            name='api',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='headers', to='AutoTest.ApiInfo', verbose_name='所属接口'),
        ),
        migrations.AddField(
