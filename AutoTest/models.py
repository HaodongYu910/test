...
class AutomationTestTask(models.Model):
    ...
    Host = models.ForeignKey(Server, on_delete=models.CASCADE, verbose_name='HOST')
...
class smoke(models.Model):
    ...
    Host = models.ForeignKey(Server, null=True, on_delete=models.CASCADE, verbose_name='Host_id')
...
class smoke_record(models.Model):
    ...
    diseases = models.CharField(max_length=30, blank=True, null=True, verbose_name="病种")
    slicenumber = models.CharField(max_length=20, blank=True, null=True, verbose_name="slicenumber")
    aistatus = models.CharField(max_length=10, blank=True, null=True, verbose_name="预测结果")
