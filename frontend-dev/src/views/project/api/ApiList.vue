  ...
  <section>
    ...
    <el-col :span="24" style="height: 46px">
      <el-form :inline="true" :model="filters" @submit.native.prevent>
        <el-form-item>
          <el-input v-model.trim="filters.name" placeholder="名称" @keyup.enter.native="getApiList" />
        </el-form-item>
        <el-form-item>
        ...
        <el-form-item>
          ...
          <el-dialog title="导入swagger接口" :visible.sync="loadSwaggerApi" :close-on-click-modal="false">
            <el-input v-model.trim="swaggerUrl" placeholder="请输入swagger接口地址" style="width:90%" />
            <el-button type="primary" :loading="addLoading" @click="addSubmit">导入</el-button>
    ...
    <!--列表-->
    <el-table v-loading="listLoading" :data="api" highlight-current-row style="width: 100%;" @selection-change="selsChange">
