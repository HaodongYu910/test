    ...
    <el-form ref="form" :model="form" :rules="formRules">
      ...
      <div style="border: 1px solid #e6e6e6;margin-bottom: 10px;padding:15px;padding-bottom: 0px">
        <el-row :gutter="10">
          ...
          <el-col :span="2">
            <el-button type="primary" :loading="loadingSend" @click="fastTest">发送</el-button>
          </el-col>
        </el-row>
      </div>
      <el-row :span="24">
        <el-collapse v-model="activeNames" @change="handleChange">
          ...
          <el-collapse-item title="请求参数" name="2">
            <div style="margin: 5px">
              <el-row :span="24">
                ...
                <el-col :span="4"><el-radio v-if="request3" v-model="radio" label="raw">源数据(raw)</el-radio></el-col>
                <el-col v-show="request3" :span="16"><el-checkbox v-show="ParameterTyep" v-model="radioType" label="3">表单转源数据</el-checkbox></el-col>
              </el-row>
            </div>
          ...
          <el-collapse-item title="响应结果" name="4">
            ...
            <el-card class="box-card">
              ...
              <div v-show="format && form.resultData" :class="resultShow? 'parameter-a': 'parameter-b'">
    ...
    fastTest: function() {
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          const url = self.form.Http4 + '://' + this.form.addr
